...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Pilot Rating' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('pilot_ratings.pilot_rating.update', $pilotRating->id) }}" id="edit_pilot_rating_form" name="edit_pilot_rating_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
